        ...
        <>
            <section className={styles.searchPet}>
                ...
                <span>
                    ...
                    distância. O pets está cheio de animais adoráveis esperando
                    por um lar amoroso.
                </span>
                <div>
                        ...
                        <>
                            ...
                            >
                                <Select
                                    ...
                                    options={Object.keys(ANIMAL_TYPES).map(
                                        (key) => ({
                                            value: key,
                                            label: (
                                                <span>{ANIMAL_TYPES[key]}</span>
                                            ),
                                        })
                                    )}
                                    onSelect={(types) =>
                            ...
                            >
                                <Select
                                    ...
                                    options={Object.keys(ANIMAL_AGE_GROUPS).map(
                                        (key) => ({
                                            value: key,
                                            label: (
                                                <span>
