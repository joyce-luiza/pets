        ...
        <div style={{ position: "fixed", right: "0" }}>
          <Carousel className={styles.carousel} autoplay autoplaySpeed={8000}>
            ...
            <div className={styles.banner}>
              ...
              ></div>
              <p className={styles.testimonialText}>
                "O site foi o elo que nos uniu a Nina, nossa adorável
                cachorrinha. Desde que ela chegou, nossas vidas se encheram de
                risadas e carinho. Não poderíamos estar mais gratos por essa
                conexão especial."
              </p>
              <div className={styles.testimonialAuthor}>
                <div></div>
            ...
            <div className={styles.banner}>
              ...
              ></div>
              <p className={styles.testimonialText}>
                "Jamais esquecerei o dia em que me deparei com a foto de Otto
                neste site. Ele se tornou mais do que um simples animal de
                estimação: é um membro querido da família."
              </p>
              <div className={styles.testimonialAuthor}>
                <div></div>
