    ...
    <>
      <div className={styles.stepFormTitle}>
        ...
        <Paragraph style={{ margin: "1em 0 2em 0" }}>
          Caso necessário, você pode conceder acesso aos outros integrantes da
          equipe da organização. Basta inserir o email de cada um, e um convite
          será enviado.
        </Paragraph>
      </div>
